...
const CheckuotSideMenu = () => {
    ...
    return (
        <aside className={`${context.isChekoutSideMenu ? 'flex' : 'hidden'} overflow-auto checkout-side-menu flex-col fixed bg-white right-0 border border-black rounded-lg`}>
            ...
            <div className="px-3">
                <h3 className="text-lg font-medium mt-6">Total: ${context.cartProducts.reduce((total, product) => total + product.price, 0)}</h3>
